...
<div id="header">
  ...
  <?php if(!isset($t_hide_social) || $t_hide_social == 'no') { ?>
  <ul class="social">
    ...
    <?php } ?>
    <?php if($t_facebookurl != ''){ if($t_facebookurl == 'no') $t_facebookurl = 'http://www.facebook.com/faviconer';?><li id="fb"><a class="ss png_crop" href="<?php echo $t_facebookurl; ?>"></a></li><?php } ?>
